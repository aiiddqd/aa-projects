...
return [
    ...
    [ // $staticRoutes
        ...
        '/catalog' => [[['_route' => 'catalog_index', '_controller' => 'App\\CatalogBundle\\Controller\\CatalogController::index'], null, null, null, false, false, null]],
        '/catalog/new' => [[['_route' => 'catalog_new', '_controller' => 'App\\CatalogBundle\\Controller\\CatalogController::new'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
